...
<div class="container">
    ...
    <div class="content" id="content">
        ...
        function helpPage() {
            ...
            echo '<li><strong>Dosya Yöneticisi:</strong> Sunucudaki dosyaları yönetmek için kullanılır.</li>';
            echo '<li><strong>Sunucu Bilgileri:</strong> Sunucu hakkında bilgi görüntüler.</li>';
            echo '<li><strong>Komutlar:</strong> Kullanılabilir komutların listesini gösterir.</li>';
            echo '<li><strong>Yardım:</strong> Uygulamanın nasıl kullanılacağı hakkında bilgi verir.</li>';
            echo '</ul>';
            echo '<p>Herhangi bir sorunuz veya sorunla karşılaşırsanız, lütfen sistem yöneticinizle iletişime geçin.</p>';
            echo '</div>';
        }
        ?>
    </div>
